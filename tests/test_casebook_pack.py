"""Regression checks for the apex-net-socket-forge casebook."""
...
from casebook.harness import assert_expected, apex_net_socket_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(apex_net_socket_forge_summary(), assert_expected())
